        ...
        <div class="table-responsive" style="width: 50%; margin: 0 auto;">
            <form action="{{ url('admin/enviar/notificacao')}}" method="POST">
                ...
                <div class="input-group mb-3">
                    ...
                    <textarea type="text" name="notiTodos" class="form-control" placeholder="Escreve aqui a notificação" aria-label="Notificaçãp" aria-describedby="basic-addon1"> </textarea>
                </div>
